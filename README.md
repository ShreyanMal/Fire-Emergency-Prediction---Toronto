...
Please find the final report for the project in the files uploaded to the repository. I could only find an earlier, unfinished version of the report. My contributions are highlighted on pages 11-15 in the report.
